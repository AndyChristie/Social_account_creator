...
def queueThread():
    ...
    print "Saving to proxies_1.txt"
    #with open("proxylist-" + dt + ".txt", "w") as fout:
    with open("proxies_.txt", "w") as fout:
...
if __name__ == "__main__":
    print "#######################################"
    print "#######################################"
    print "###### Proxy Scraper Script V1.3 ######"
    print "############ Feanor @ HF ##############"
    print "#######################################"
    print "#######################################\n"
